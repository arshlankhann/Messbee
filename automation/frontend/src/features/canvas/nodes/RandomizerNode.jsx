    ...
    <div style={{ position: 'relative', width: '280px', fontFamily: '"Inter", "Outfit", sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '12px', background: '#fafafa' }}>
          ...
          <div style={{ background: 'white', borderRadius: '6px', padding: '12px', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '12px', fontWeight: '600', color: '#374151' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '12px' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <Handle type="source" position={Position.Right} id="path_a" className="custom-handle" style={{ right: '-18px', top: '50%', transform: 'translateY(-50%)', background: 'white', border: '2px solid #d1d5db', width: '12px', height: '12px' }} />
            </div>
            {/* PATH B Handle */}
            <div style={{ position: 'relative' }}>
              <div style={branchStyle('#f59e0b', `Path B (${100 - splitPercentage}%)`)}></div>
              <Handle type="source" position={Position.Right} id="path_b" className="custom-handle" style={{ right: '-18px', top: '50%', transform: 'translateY(-50%)', background: 'white', border: '2px solid #d1d5db', width: '12px', height: '12px' }} />
            </div>
          </div>
        </div>
      </div>
