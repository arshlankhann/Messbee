...
// Helper to determine minimum required plan for a feature
export const FEATURE_REQUIREMENTS = {
  developerApi: { plan: "growth", name: "Growth" },
  commerce: { plan: "growth", name: "Growth" },
  appsIntegration: { plan: "basic", name: "Basic" },
  exportContactsCsv: { plan: "growth", name: "Growth" },
  roundRobinAssignment: { plan: "growth", name: "Growth" },
  scheduleCampaign: { plan: "basic", name: "Basic" },
  recurringCampaign: { plan: "professional", name: "Professional" },
  webhook: { plan: "professional", name: "Professional" },
  numberMasking: { plan: "professional", name: "Professional" },
  advancedChatbot: { plan: "growth", name: "Growth" },
  templateAnalytics: { plan: "basic", name: "Basic" },
  templateGallery: { plan: "basic", name: "Basic" },
};
...
export const getRequiredPlan = (feature) => {
  return FEATURE_REQUIREMENTS[feature] || { plan: "growth", name: "Growth" };
};
