      ...
      <div className="min-h-screen bg-[#F8FAFC] p-6 lg:p-10 font-['Urbanist'] pb-20 relative">
         ...
         <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-3">
               ...
               <div>
                  <h1 className="text-2xl font-bold tracking-tight text-slate-900">Active Plan</h1>
                  <p className="text-gray-500 text-[13px] mt-1 font-medium">Manage your subscription and resource allocation</p>
               </div>
            </div>
