...
for (const file of files) {
  ...
  // It's tricky to distinguish the main container from inner panels via regex.
  // But we can blindly replace standard colors with dark theme colors.
  ...
  // We can also inject a plus sign in handles if possible, but that might be complex via regex.
  // Instead, just changing border color to green is a good start.
